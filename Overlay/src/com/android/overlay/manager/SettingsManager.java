...
public class SettingsManager {
	...
	public static boolean debugLog() {
		return getBoolean(Environment.getResId("R.string.debug_log_key"),
				Environment.getResId("R.bool.debug_log_default"));
	}

	public static boolean eventsPersistent() {
		return getBoolean(
				Environment.getResId("R.string.events_persistent_key"),
				Environment.getResId("R.bool.events_persistent_default"));
	}

	public static Uri eventsSound() {
		return getSound(Environment.getResId("R.string.events_sound_key"),
				Settings.System.DEFAULT_NOTIFICATION_URI,
				Environment.getResId("R.string.events_sound_default"));
	}

	public static boolean eventsVibro() {
		return getBoolean(Environment.getResId("R.string.events_vibro_key"),
				Environment.getResId("R.bool.events_vibro_default"));
	}

	public static boolean eventsIgnoreSystemVibro() {
		return getBoolean(Environment
				.getResId("R.string.events_ignore_system_vibro_key"),
				Environment
						.getResId("R.bool.events_ignore_system_vibro_default"));
	}

	public static boolean eventsLightning() {
		return getBoolean(
				Environment.getResId("R.string.events_lightning_key"),
				Environment.getResId("R.bool.events_lightning_default"));
	}
